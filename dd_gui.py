...
from my_email import DailyDigestEmail
...
class DailyDigestGUI:
    ...
    def __init__(self, root):
        ...
        title_label = ttk.Label(self.__root, text = ' \U0001F4DC Email Bot by Venura Pussella \U0001F4DC',
    ...
    """
    def __save_config(self, file_path="Email Bot_2/dd_config.json"):
    ...
    """
    def __load_config(self, file_path="Email Bot_2/dd_config.json"):
